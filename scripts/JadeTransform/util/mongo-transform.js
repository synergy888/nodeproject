    ...
    transformMongoJSONFile: function(transformProperties, sourceFile, destinationFile){
        try {
            ...
            if (sourceFile.indexOf('companies.json') > -1) {
                ...
                data = data.replace(/~Companies_products_commerce_settings_systemType~/g, transformMongoProperties.companyObj.products_commerce_settings_systemType);
                data = data.replace(/"~Companies_products_commerce_settings_documentsConfig~"/g, transformMongoProperties.companyObj.products_commerce_settings_documentsConfig);
                ...
                data = data.replace(/~Companies_products_commerce_settings_company_advancedOrderRequest~/g, transformMongoProperties.companyObj.products_commerce_settings_company_advancedOrderRequest);
                ...
                data = data.replace(/~Companies_products_commerce_settings_user_timeZone_value~/g, transformMongoProperties.companyObj.products_commerce_settings_user_timeZone_value);
                data = data.replace(/~Companies_products_commerce_settings_user_timeZone_operator~/g, transformMongoProperties.companyObj.products_commerce_settings_user_timeZone_operator);
                data = data.replace(/~Companies_products_commerce_settings_user_timeZone_hours~/g, transformMongoProperties.companyObj.products_commerce_settings_user_timeZone_hours);
                data = data.replace(/~Companies_products_commerce_settings_user_timeZone_minutes~/g, transformMongoProperties.companyObj.products_commerce_settings_user_timeZone_minutes);
